...
ll_path = '../../../data_aggregation/BPP/HighLevel/result_BPP70_musket.csv'
...
Average75 = [Musket1024Average, Musket2048Average, Musket4096Average, Musket8192Average]
...
Average70 = [ll1024Average, ll2048Average, ll4096Average, ll8192Average]

#iterate over files
for f in range(6):

    data70 = pd.read_csv(ll_path, delimiter=',', header=None)
