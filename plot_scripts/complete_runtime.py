...
# was my_data
runtimes = pd.read_csv('../data_aggregation/Musket_1,3,5-12_average.csv', delimiter=',', header=None)
runtimes_lowlevel = pd.read_csv('../data_aggregation/lowlevel_completeruntime.csv', delimiter=',', header=None)
...
yvalue_1024_ll = runtimes_lowlevel.iloc[[2]].astype(float).values[0][:-1]
yvalue_2048_ll = runtimes_lowlevel.iloc[[3]].astype(float).values[0][:-1]
yvalue_4096_ll = runtimes_lowlevel.iloc[[4]].astype(float).values[0][:-1]
yvalue_8192_ll = runtimes_lowlevel.iloc[[5]].astype(float).values[0][:-1]
...
plt.plot(xvalue, yvalue_1024_ll, linestyle='dashed', marker='o', label = "1024 ll", color='#348ABD')
plt.plot(xvalue, yvalue_2048_ll, linestyle='dashed', marker='o', label = "2048 ll", color='#A60628')
plt.plot(xvalue, yvalue_4096_ll, linestyle='dashed', marker='o', label = "4096 ll", color='#7A68A6')
plt.plot(xvalue, yvalue_8192_ll, linestyle='dashed', marker='o', label = "8192 ll", color='#467821')
